      ...
      <section className="pages-bg">
        <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-8 col-lg-9 text-right pages-bg py-4 px-5">
                  ...
                  <div className="row justify-content-between">
                    {displayList && displayList.length > 0 ? (
                      displayList.map((item) => (
                        <div key={item._id} className="card col-lg-5 my-3 listCard-pad-x py-2" >
                          <div className="">
                            <div className="">
                              <img src={item.productImg} className="img-fluid rounded-start h-lg-25 img-sma-ht" alt="productImg" />
                            </div>
                            <div className="">
                              <div className="card-body d-flex justify-content-between">
                                <div>
                                  ...
                                  <button
                                    ...
                                    className={cartBtn.includes(item._id) ? "btn btn-primary px-4 w-100" : "btn btn-outline-primary px-4 w-100"}>
