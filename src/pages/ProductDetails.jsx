...
export const ProductDetails = () => {
    ...
    const {category, loading, quantity, setQuantity, addToCart} = useContext(ProductContext)
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-3 px-4 border-2 text-center border-start border-end border-warning py-3">
                            ...
                            <button onClick={() => addToCart(details._id)} className="btn btn-outline-primary my-3 w-100">Add to Cart</button>
                        </div>
